...
_306.searchbox.find("input.searchbox-text").data('sol-search-name',$(item.target).attr("name")||item.text);
_301(_305);
};
};
function _308(_309){
...
e.preventDefault();
opts.value=$(this).val();
var sol_search_name = _30b.attr("name") && _30b.attr("name") != '' ? _30b.attr("name") : _30b.data('sol-search-name');
opts.searcher.call(_309,opts.value,sol_search_name);
return false;
}
});
